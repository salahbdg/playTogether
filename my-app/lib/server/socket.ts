...
import { startGame, handlePlayerInput, getGameState, attachIO } from "@/lib/server/game/gameManager";
...
function handleLeave(socket: Socket<ClientToServerEvents, ServerToClientEvents>) {
